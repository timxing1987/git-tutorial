...
namespace Senparc.Weixin.Open.CommonAPIs
{
    ...
    public class CommonApi
    {
        ...
        /// <returns></returns>
        public static ComponentAccessTokenResult GetComponentAccessToken(string componentAppId,
            string componentAppSecret, string componentVerifyTicket, int timeOut = Config.TIME_OUT)
        {
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static PreAuthCodeResult GetPreAuthCode(string componentAppId, string componentAccessToken,
        ...
        //////////////////////////////////////////////////////////////////////////////////
        /// <summary>
        ///     文档：https://open.weixin.qq.com/cgi-bin/showdocument?action=dir_list&t=resource/res_list&verify=1&id=open1421823488
        ///     &token=&lang=zh_CN
