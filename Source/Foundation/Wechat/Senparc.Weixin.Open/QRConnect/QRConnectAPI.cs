...
namespace Senparc.Weixin.Open.QRConnect
{
    ...
    public static class QRConnectAPI
    {
        ...
        /// <returns></returns>
        public static string GetQRConnectUrl(string appId, string redirectUrl, string state, OAuthScope[] scopes,
        ...
        /// <returns></returns>
        public static QRConnectAccessTokenResult GetAccessToken(string appId, string appSecret, string code,
        ...
        /// <returns></returns>
        public static RefreshAccessTokenResult RefreshToken(string appId, string refreshToken,
        ...
        {
            var url = string.Format("https://api.weixin.qq.com/sns/userinfo?access_token={0}&openid={1}", accessToken,
                openId);
            /*
        ...
        {
            var url = string.Format("https://api.weixin.qq.com/sns/auth?access_token={0}&openid={1}", accessToken,
                openId);
