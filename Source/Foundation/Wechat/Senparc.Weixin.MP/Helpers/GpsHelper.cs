...
namespace Senparc.Weixin.MP.Helpers
{
    public class GpsHelper
    {
        ...
        {
            var jl_jd = 102834.74258026089786013677476285; //每经度单位米;
            var jl_wd = 111712.69150641055729984301412873; //每纬度单位米; 
            var b = Math.Abs((e1 - e2)*jl_jd);
            var a = Math.Abs((n1 - n2)*jl_wd);
