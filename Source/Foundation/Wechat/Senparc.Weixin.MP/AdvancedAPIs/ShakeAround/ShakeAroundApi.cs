...
namespace Senparc.Weixin.MP.AdvancedAPIs
{
    ...
    public static class ShakeAroundApi
    {
        ...
        public static WxJsonResult Register(string accessTokenOrAppId, RegisterData data, int timeOut = Config.TIME_OUT)
        {
            ...
            {
                var url = string.Format("https://api.weixin.qq.com/shakearound/account/register?access_token={0}",
                    accessToken);
        ...
        public static GetAuditStatusResultJson GetAuditStatus(string accessTokenOrAppId)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var url = string.Format("https://api.weixin.qq.com/shakearound/account/auditstatus?access_token={0}",
                    accessToken);
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static DeviceApplyResultJson DeviceApply(string accessTokenOrAppId, int quantity, string applyReason,
            string comment = null, long? poiId = null, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var url = string.Format("https://api.weixin.qq.com/shakearound/device/applyid?access_token={0}",
                    accessToken);
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static WxJsonResult DeviceUpdate(string accessTokenOrAppId, long deviceId, string uuId, long major,
            long minor, string comment, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var url = string.Format("https://api.weixin.qq.com/shakearound/device/update?access_token={0}",
                    accessToken);
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static WxJsonResult DeviceBindLocatoin(string accessTokenOrAppId, long deviceId, string uuId, long major,
            long minor, long poiId, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var url = string.Format("https://api.weixin.qq.com/shakearound/device/bindlocation?access_token={0}",
                    accessToken);
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static UploadImageResultJson UploadImage(string accessTokenOrAppId, string file,
            int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var url = string.Format("https://api.weixin.qq.com/shakearound/material/add?access_token={0}",
                    accessToken);
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static AddPageResultJson AddPage(string accessTokenOrAppId, string title, string description,
            string pageUrl,
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static UpdatePageResultJson UpdatePage(string accessTokenOrAppId, long pageId, string title,
            string description, string pageUrl,
            string iconUrl, string comment = null, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var url = string.Format("https://api.weixin.qq.com/shakearound/page/update?access_token={0}",
                    accessToken);
        ...
        public static WxJsonResult DeletePage(string accessTokenOrAppId, long[] pageIds, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var url = string.Format("https://api.weixin.qq.com/shakearound/page/delete?access_token={0}",
                    accessToken);
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static WxJsonResult BindPage(string accessTokenOrAppId,
            DeviceApply_Data_Device_Identifiers deviceIdentifier, long[] pageIds, ShakeAroundBindType bindType,
            ShakeAroundAppendType appendType, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var url = string.Format("https://api.weixin.qq.com/shakearound/device/bindpage?access_token={0}",
                    accessToken);
        ...
        ///     查询设备列表Api url
        /// </summary>
        private static readonly string searchDeviceUrl =
            "https://api.weixin.qq.com/shakearound/device/search?access_token={0}";
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static DeviceSearchResultJson SearchDeviceById(string accessTokenOrAppId,
            List<DeviceApply_Data_Device_Identifiers> deviceIdentifiers, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var data = new
                ...
                return CommonJsonSend.Send<DeviceSearchResultJson>(accessToken, searchDeviceUrl, data,
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static DeviceSearchResultJson SearchDeviceByRange(string accessTokenOrAppId, int begin, int count,
            int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static DeviceSearchResultJson SearchDeviceByApplyId(string accessTokenOrAppId, long applyId, int begin,
        ...
        private static readonly string searchPageUrl =
            ...
            int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                ...
                return CommonJsonSend.Send<SearchPages_Data_Page>(accessToken, searchPageUrl, data,
                    CommonJsonSendType.POST,
                    timeOut);
            }, accessTokenOrAppId);
        }
