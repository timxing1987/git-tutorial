...
namespace Senparc.Weixin.MP.AdvancedAPIs
{
    ...
    public static class CardApi
    {
        ...
        /// <returns></returns>
        public static CardCreateResultJson CreateCard(string accessTokenOrAppId, BaseCardInfo cardInfo,
            int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                ...
                var cardType = cardInfo.GetCardType();
            ...
            bool isUniqueCode = false, string balance = null, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var urlFormat = string.Format("https://api.weixin.qq.com/card/qrcode/create?access_token={0}",
                    accessToken);
        ...
        /// <returns></returns>
        public static ShelfCreateResultJson ShelfCreate(string accessTokenOrAppId, ShelfCreateData data,
            int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var urlFormat = string.Format("https://api.weixin.qq.com/card/landingpage/create?access_token={0}",
                    accessToken);
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static WxJsonResult CodeDeposit(string accessTokenOrAppId, string cardId, string[] codeList,
            int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var urlFormat = string.Format("http://api.weixin.qq.com/card/code/deposit?access_token={0}", accessToken);
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static GetDepositCountResultJson GetDepositCount(string accessTokenOrAppId, string cardId,
            int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var urlFormat = string.Format("http://api.weixin.qq.com/card/code/getdepositcount?access_token={0}",
                    accessToken);
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static CheckCodeResultJson CheckCode(string accessTokenOrAppId, string cardId, string[] codeList,
            int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var urlFormat = string.Format("http://api.weixin.qq.com/card/code/checkcode?access_token={0}",
                    accessToken);
        ...
        public static GetHtmlResult GetHtml(string accessTokenOrAppId, string cardId, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var urlFormat = string.Format("https://api.weixin.qq.com/card/mpnews/gethtml?access_token={0}",
                    accessToken);
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static CardConsumeResultJson CardConsume(string accessTokenOrAppId, string code, string cardId = null,
            int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var urlFormat = string.Format("https://api.weixin.qq.com/card/code/consume?access_token={0}",
                    accessToken);
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static CardDecryptResultJson CardDecrypt(string accessTokenOrAppId, string encryptCode,
            int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var urlFormat = string.Format("https://api.weixin.qq.com/card/code/decrypt?access_token={0}",
                    accessToken);
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static CardDeleteResultJson CardDelete(string accessTokenOrAppId, string cardId,
            int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static CardGetResultJson CardGet(string accessTokenOrAppId, string code, string cardId = null,
            int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static CardBatchGetResultJson CardBatchGet(string accessTokenOrAppId, int offset, int count,
            int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static CardDetailGetResultJson CardDetailGet(string accessTokenOrAppId, string cardId,
            int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static WxJsonResult CardChangeCode(string accessTokenOrAppId, string code, string cardId, string newCode,
            int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static WxJsonResult CardUnavailable(string accessTokenOrAppId, string code, string cardId = null,
            int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var urlFormat = string.Format("https://api.weixin.qq.com/card/code/unavailable?access_token={0}",
                    accessToken);
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static WxJsonResult CardUpdate(string accessTokenOrAppId, CardType cardType, object data,
            string cardId = null, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static WxJsonResult AuthoritySet(string accessTokenOrAppId, string[] openIds, string[] userNames,
            int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var urlFormat = string.Format("https://api.weixin.qq.com/card/testwhitelist/set?access_token={0}",
                    accessToken);
        ...
        /// <returns></returns>
        public static WxJsonResult MemberCardActivate(string accessTokenOrAppId, string membershipNumber, string code,
            string cardId, string activateBeginTime = null, string activateEndTime = null, string initBonus = null,
            string initBalance = null, string initCustomFieldValue1 = null, string initCustomFieldValue2 = null,
            string initCustomFieldValue3 = null, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var urlFormat = string.Format("https://api.weixin.qq.com/card/membercard/activate?access_token={0}",
                    accessToken);
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static WxJsonResult ActivateUserFormSet(string accessTokenOrAppId, ActivateUserFormSetData data,
            int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var urlFormat =
                    string.Format("https://api.weixin.qq.com/card/membercard/activateuserform/set?access_token={0}",
                        accessToken);
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static WxJsonResult RecommendSet(string accessTokenOrAppId, string cardId, CardCell cardCellData = null,
            UrlCell urlCellData = null, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var urlFormat = string.Format("https://api.weixin.qq.com/card/update?access_token={0}", accessToken);
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static WxJsonResult PayCellSet(string accessTokenOrAppId, string cardId, bool isOpen,
            int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static UpdateUserResult UpdateUser(string accessTokenOrAppId, string code, string cardId, int addBonus,
            int addBalance,
            int? bonus = null, int? balance = null, string recordBonus = null, string recordBalance = null,
            string customFieldValue1 = null,
            string customFieldValue2 = null, string customFieldValue3 = null, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var urlFormat = string.Format("https://api.weixin.qq.com/card/membercard/updateuser?access_token={0}",
                    accessToken);
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static MemberCardDeal MemberCardDeal(string accessTokenOrAppId, string code, string cardId,
            string recordBonus, decimal addBonus, decimal addBalance, string recordBalance,
            int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static WxJsonResult MovieCardUpdate(string accessTokenOrAppId, string code, string cardId,
            string ticketClass, string showTime, int duration, string screeningRoom, string[] seatNumbers,
            int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var urlFormat = string.Format("https://api.weixin.qq.com/card/movieticket/updateuser?access_token={0}",
                    accessToken);
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static WxJsonResult BoardingPassCheckIn(string accessTokenOrAppId, string code, string cardId,
            string passengerName, string classType, string seat, string etktBnr, string qrcodeData,
            bool isCancel = false, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var urlFormat = string.Format("https://api.weixin.qq.com/card/boardingpass/checkin?access_token={0}",
                    accessToken);
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static WxJsonResult UpdateUserBalance(string accessTokenOrAppId, string code, string cardId,
            decimal balance, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var urlFormat =
                    string.Format("https://api.weixin.qq.com/card/luckymoney/updateuserbalance?access_token={0}",
                        accessToken);
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static WxJsonResult UpdateMeetingTicket(string accessTokenOrAppId, string code, string cardId = null,
            string zone = null, string entrance = null, string seatNumber = null, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var urlFormat = string.Format(
                    "https://api.weixin.qq.com/card/meetingticket/updateuser?access_token={0}", accessToken);
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static GetCardListResult GetCardList(string accessTokenOrAppId, string openId, string cardId = null,
            int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                var urlFormat = string.Format("https://api.weixin.qq.com/card/user/getcardlist?access_token={0}",
                    accessToken);
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static WxJsonResult ModifyStock(string accessTokenOrAppId, string cardId, int increaseStockValue = 0,
            int reduceStockValue = 0, int timeOut = Config.TIME_OUT)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
