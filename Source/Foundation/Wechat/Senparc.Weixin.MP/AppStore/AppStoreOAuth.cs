...
namespace Senparc.Weixin.MP.AppStore
{
    public static class AppStoreOAuth
    {
        ...
        /// <returns></returns>
        public static string GetAuthorizeUrl(int weixinId, string clientId, string redirectUrl, string state,
            string responseType = "code")
        {
            var url =
                string.Format(
                    Domain + "/OAuth2/Authorize?weixinId={0}&clientId={1}&RedirectUri={2}&response_type=code&state={3}",
        ...
        /// <returns></returns>
        public static OAuthAccessTokenResult GetAccessToken(string clientId, string clientSecret, string code,
