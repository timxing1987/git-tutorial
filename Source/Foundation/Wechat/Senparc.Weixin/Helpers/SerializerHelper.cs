...
namespace Senparc.Weixin.Helpers
{
    ...
    public class SerializerHelper
    {
        ...
        public static string DecodeUnicode(Match match)
        {
            ...
            var outStr = (char) int.Parse(match.Value.Remove(0, 2), NumberStyles.HexNumber);
        ...
        public string GetJsonString(object data, JsonSetting jsonSetting = null)
        {
            ...
            MatchEvaluator evaluator = DecodeUnicode;
            var json = Regex.Replace(jsonString, @"\\u[0123456789abcdef]{4}", evaluator);
                //或：[\\u007f-\\uffff]，\对应为\u000a，但一般情况下会保持\
            return json;
        }
    }
